...
if __name__ == '__main__':
    ...
    model_directory = Path(settings.MODELS / 'log_normal')
    ...
    visualization.visualize_survival_function(
        model=model,
        title='Log Normal Fitter - Survival Function',
    ...
    visualization.visualize_cumulative_hazard(
        model=model,
        title='Log Normal Fitter Cumulative Hazard',
    ...
    visualization.visualize_hazard(
        model=model,
        title='Log Normal Fitter - Hazard',
