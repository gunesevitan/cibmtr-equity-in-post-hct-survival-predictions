...
if __name__ == '__main__':
    ...
    for fold in folds:
        ...
        if 'svc' in config['model_class'].lower() or 'svr' in config['model_class'].lower():
            model = getattr(sklearn.svm, config['model_class'])(**config['model_parameters'])
        ...
        try:
            df_coefficients.loc[:, fold] = model.coef_
    ...
    visualization.visualize_feature_importance(
        ...
        title=f'{config["model_class"]} Model Coefficients',
